...
| Frontend IndexedDB (`ZkKeyVault`)           | master key (non-extractable CryptoKey)                            | XSS can _use_ but not _export_; cleared on logout                                       | SEC-W5 (XSS) |
