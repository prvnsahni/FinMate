...
**Critical rule:** FinMate is a **live production application.** *"Secure the existing product without unnecessarily breaking the product."* **SECURITY/LEGAL > EXISTING CRITICAL FUNCTIONALITY > BACKWARD COMPATIBILITY > NEW ARCHITECTURE > CONVENIENCE.** No clean-slate rewrite.
...
| W-INT-* / W-DOM-* | none | **TARGET/BLOCKED** (V2/future) |
...
*End of Document #19 (Pre-Implementation Execution Plan). STOP.*
