...
*These are documentation-hygiene items; the code is authoritative. Regenerate `openapi.yaml` from code before any GA.*

---

*Index for Document #16. No code changed. STOP — no migrations, no implementation, no tickets.*
